package com.immdream.login.security;

import cn.hutool.core.date.DateField;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.IdUtil;
import com.immdream.commons.util.RedisUtil;
import com.immdream.login.config.SecurityProperties;
 ...
 * Token 管理
 * <p>
 * news com.immdream.login.security
 *
 * @author immDream
...
public class TokenManager implements InitializingBean {
    ...
    public TokenManager(SecurityProperties properties, RedisUtil redisUtil) {
