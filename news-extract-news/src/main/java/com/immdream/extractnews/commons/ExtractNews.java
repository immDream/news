...
public class ExtractNews {
    ...
    public static void main(String[] args) throws IOException {
        ExtractNews newCl = new ExtractNews();
        String url="https://world.huanqiu.com/article/4CfmZfV5FST";
    ...
    public void  downloadImg(String ImgUrl,int count) throws IOException{
        //下载图片
        String str="D:\\project\\img\\";//保存下载图片文件夹
    ...
    public String getNewtext(Document doc){
        //获取新闻内容
        String text = doc.select("article").text();
    ...
    public static void downloadPage(String str){
        //下载网页
        String filestr="D:/project/img";//设置网页的保存地址
        try {
