...
public class RedisUtil<T> {
    ...
    public RedisUtil(RedisTemplate<Object, T> redisTemplate) {
    ...
    public boolean lock(String lock, int time) {
        boolean lock1 = redisTemplate.opsForValue().setIfAbsent("lock", (T)"1",time, TimeUnit.SECONDS);
        return lock1;
    }
